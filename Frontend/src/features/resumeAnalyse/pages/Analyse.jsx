...
import { getResumeById } from "../services/resume-analyse-api";

const Analyse = () => {
  const { id } = useParams();
  const { resumeReport, setResumeReport, loading, setLoading } =
    useResumeAnalyse();
  ...
  return (
    <div className="analysis-page">
      <div className="analysis-header">
        <h1>Analysis Results</h1>
        <p>Senior Frontend Engineer Application Review</p>
      </div>
